...
#define search_start_x  250
#define search_start_y  150
#define search_item_height  40
#define search_spacing  20
#define search_item_width  300
...
void drawCenteredText(int x, int y, int width, const char* text);
void outimage(const int x, const int y, const char* postion);
void drawSearchMenu(const std::vector<MenuItem>& item, int hoverId = -1, int clickId = -1);
