...
void drawMenu()
{
	...
	outtextxy(start_x, y, "a. 按姓名模糊查找");		y += item_height + spacing;  outimage(start_x - 25, y - 35, "./fuzzy_name.png");
	outtextxy(start_x, y, "b. 按电话模糊查找");		y += item_height + spacing;	 outimage(start_x - 25, y - 35, "./fuzzy_phone.png");
	outtextxy(start_x, y, "c. 分页显示联系人");		y += item_height + spacing;  outimage(start_x - 25, y - 35, "./show_paged.png");
